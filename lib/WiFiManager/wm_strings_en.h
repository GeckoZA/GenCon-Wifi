...
"<form action='/info'    method='get'><button>Wifi Info</button></form><br/>\n", // MENU_INFO
"<form action='/param'   method='get'><button>Generator Config</button></form><br/>\n",//MENU_PARAM
...
const char S_brand[]              PROGMEM = "GENCon WiFi";
